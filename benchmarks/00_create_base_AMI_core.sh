...
ami_id=$(aws --region $region ec2 create-image --instance-id $instance_id --name "Kalis benchmark base RHEL 8$arm" | jq -r '.ImageId')
echo " success ($ami_id)\n"
